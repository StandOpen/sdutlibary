...
public class HotSc extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	GetInfo.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				showRoundProcessDialog(HotSc.this.getParent(),R.layout.loading_process_dialog_color);
    ...
    public class updatethread extends Thread
    {
       ...
       Handler handler=new Handler(){
   		...
   		public void handleMessage(Message msg) {
   			...
   			if(type_net==1)
   			{
   			list.setAdapter(new DetailAdapter(HotSc.this,items));
   			}
   			else
   			{
...
if(checkNetWorkStatus())
{
			...
			String url="http://222.206.65.12/opac/vs_rank.php";
...
else
{
    ...
    public void createDB1() {
		String DB_NAME = "hotsc";
		mDBHelper = new DBHelper(HotSc.this,DB_NAME, null, 1);
	...
	public void ViewRecords() {
		...
		if (c.moveToFirst()) {
			...
			list.setAdapter(new DetailAdapter(HotSc.this, list1));
